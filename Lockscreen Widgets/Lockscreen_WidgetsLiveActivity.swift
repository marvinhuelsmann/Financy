...
struct Lockscreen_WidgetsLiveActivity_Previews: PreviewProvider {
    static let attributes = Lockscreen_WidgetsAttributes(name: "Me")
    static let contentState = Lockscreen_WidgetsAttributes.ContentState(value: 3)
